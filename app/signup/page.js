    ...
    const fetchMemberships = async () => {
        ...
        if (response.ok) {
            ...
            json.forEach((membership) => {
                ...
                if (membership.PublicCanApply == true) { membershipArr.push(membership) }
            })
    ...
    const handleSubmit = async (e) => {
        ...
        let body = {
            ...
            FieldValues: [
                ...
                {
                    FieldName: 'If a member referred you to the association please list their name and company',
        ...
        <main>
            ...
            <div>
                ...
                <form onSubmit={handleSubmit} className="p-10">
                    ...
                    />
                    <label htmlFor='Secondary Email Address'>Secondary Email Address</label>
                    <input
                        className='hi'
                        type="text"
                    ...
                    />
                    <p>USE THIS FIELD IF YOU NEED INVOICES SENT TO ANOTHER EMAIL ADDRESS. THIS ADDRESS WILL RECEIVE ALL EMAILS FROM THE GFWBA SYSTEM: INVOICES, EVENT NOTICES, ETC.</p>
                    ...
                    {classifications.map((c) => (
                        <div key={c.name} className="flex">
                            <input type="checkbox" id={c.name} name={c.name} value={c.name} />
                            <label>{c.name}</label>
                        </div>
                    ))}
                    ...
                    />
                    <p>BE SURE TO INCLUDE http://</p>
                    <label htmlFor='referred'>If a member referred you to the association please list their name and company</label>
                    <textarea
                        value={referredBy}
                        onChange={(e) => { setReferredBy(e.target.value) }}
                        rows="4" cols="50"
                    ></textarea>
                    <p>If someone invited you to join the GFWBA, please list their name. If no one referred you please enter NA</p>
                    ...
                    />
                    <p>The URL to your company Facebook page.</p>
                    ...
                    />
                    <p>The URL to your Twitter page.</p>
                    ...
                    <input
                        ...
                        value={houzz}
                        onChange={(e) => { setHouzz(e.target.value) }}
                    />
                    <p>example: https://www.houzz.com/pro/COMPANY-NAME/</p>
                    ...
                    />
                    <p>example: https://www.youtube.com/channel/UCNughPUDCxAanvmiqFEIS-w?sub_confirmation=1</p>
                    ...
                    <label htmlFor='Member Since'>Member of GFW Builders Assocition Since</label>
                    <input
                        className='hi'
                        type="text"
